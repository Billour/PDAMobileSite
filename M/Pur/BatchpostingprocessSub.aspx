<%@ Page Title="" Language="C#" MasterPageFile="~/M/Mobile.Master" AutoEventWireup="true" CodeBehind="BatchpostingprocessSub.aspx.cs" Inherits="RePonMobile.M.Pur.BatchpostingprocessSub" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainHeader" runat="server">
    <h1 style="font-size: 18px;">
        <div id="head" style="vertical-align: top;">委外-原物料批次過帳處理</div>
        ...
        <li>
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 80%;">
                        <select id="Ordertype">
                            <option value="ALL-Sub">委外全部</option>
                            <option value="SV14">委外直接入庫</option>
                            <option value="SV11">委外收料單</option>
                        </select>
                    </td>
                </tr>
            </table>
