<%@ Page Title="" Language="C#" MasterPageFile="~/M/Mobile.Master" AutoEventWireup="true" CodeBehind="ReceivePur.aspx.cs" Inherits="eAIWeb.M.Pur.ReceivePur" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Script" runat="server">
    <script src="<% =(Request.ApplicationPath == "/" ? "" : Request.ApplicationPath) %>/M/Pur/Scripts/ReceivePur.js?20160801"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainHeader" runat="server">
    <h1 style="font-size: 18px;">
        <div id="head" style="vertical-align: top;">收料單</div>
        ...
        <li data-role="fieldcontain">
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td align="left" style="width: 40%">
                        <input type="date" data-clear-btn="true" id="txtPlanRecvDate" value="" style="min-width: 150px; width: 100%;">
                    </td>
                </tr>
            </table>
            <table style="width: 100%">
                <tr>
                    <td align="right" style="width: 20%; white-space: nowrap;">&nbsp;<a id="btnVendor" href="#diaVendor" data-role="button" data-rel="page" data-transition="pop" data-theme="a" data-inline="true" data-icon="search">供應商</a>
                    </td>
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <a data-role="button" id="liSave" href="#">收料單儲存</a>
                    </td>
                    <td>
...
<asp:Content ID="Content4" ContentPlaceHolderID="OtherPage" runat="server">
    ...
    <div id="diaPur" data-role="page" data-theme="c" data-cache="never">
        ...
        <div data-role="content">
            <%--20160715 增加單號加料號過濾--%>
            <div style="background-color: mistyrose; padding: 5px; border-radius: 10px;">
                <table style="width: 100%;">
                    <tr>
                        <td>
                            <input type="text" data-clear-btn="true" id="txtrec_pur_nbr" value="" placeholder="單號過濾" style="width: 100%;">
                        </td>
                        <td>
                            <input type="text" data-clear-btn="true" id="txtrec_item_no" value="" placeholder="料號過濾" style="width: 100%;">
                        </td>
                    </tr>
                </table>
                <table style="width: 100%;">
                    <tr>
                        <td style="text-align: left; white-space: nowrap;">
                            <fieldset data-role="controlgroup" data-mini="true">
                                <legend></legend>
                                <input type="radio" name="rblrecsort" id="rblrecsorta" value="pur_nbr" checked="checked">
                                <label for="rblrecsorta">單號排序</label>
                                <input type="radio" name="rblrecsort" id="rblrecsortb" value="plan_recv_date">
                                <label for="rblrecsortb">預計到廠日排序</label>
                            </fieldset>
                        </td>
                        <td>
                            <a data-role="button" id="btnrec_nbrQuery" href="#">查詢</a>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div data-role="content">
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td style="width: 60%; text-align: left;">
                        <input type="number" pattern="[0-9]*" data-clear-btn="true" id="txtRecQty" value="">
                    </td>
                    <td style="width: 20%; text-align: left;"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 60%; text-align: left;">
                        <input type="date" disabled="disabled" data-rel="back" id="txtplan_recv_date" value="">
                    </td>
                    <td style="width: 20%; text-align: left;"></td>
                </tr>
            </table>
