...
$(document).ready(function () {
    ...
    //#region 搜尋採購單 event  20160802 有過濾條件  event 修改成三日前不可收料
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (!!data) {
                            ...
                            //#endregion =======json處理=======
                            ClearOrderSort();//20160802 清空排序資料
                            hideDelete();
                        }
                    },
                    error: function (xhr, ajaxOptions, thrownError) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.length > 0) {
                    ...
                    $('#txtRecQty').val(new Number(data[0].rec_qty).toFixed(1));
