...
<asp:Content ID="Content1" ContentPlaceHolderID="Script" runat="server">
    <script type="text/javascript" src="<% =(Request.ApplicationPath == "/" ? "" : Request.ApplicationPath) %>/M/Pur/Scripts/ReturnReceiverPur.js?20160803"></script>
</asp:Content>
...
<%--                        <a id="btnrec_seq" href="#diarec_seq" data-role="button" data-rel="page" data-transition="pop" data-theme="a" data-inline="true" data-mini="true" data-icon="search">搜尋</a>--%>
                ...
                <tr>
                    ...
                    <td style="width: 60%; text-align: left;">
                        <input type="number" pattern="[0-9]*" data-clear-btn="true" id="txtreturn_qty" value="">
                    </td>
                    <td style="width: 20%; text-align: left;"></td>
                </tr>
                <tr>
