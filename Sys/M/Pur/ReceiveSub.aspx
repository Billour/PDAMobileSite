<%@ Page Title="" Language="C#" MasterPageFile="~/M/Mobile.Master" AutoEventWireup="true" CodeBehind="ReceiveSub.aspx.cs" Inherits="RePonMobile.M.Pur.ReceiveSub" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Script" runat="server">
    <script src="<% =(Request.ApplicationPath == "/" ? "" : Request.ApplicationPath) %>/M/Pur/Scripts/ReceiveSub.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainHeader" runat="server">
    <h1 style="font-size: 18px;">
        <div id="head" style="vertical-align: top;">委外收料單</div>
                    ...
                    <td style="width: 40%;">
                        <div data-role="navbar">
                            <ul>
                                ...
                                <li id="Edit"><a href="#" class="ui-btn-active">修改</a></li>
                                <li id="Delete"><a href="#">刪除</a></li>
                                <%--        <li id="Print"><a href="#">列印</a></li>--%>
                            </ul>
                        </div>
                    </td>
                    <td id="footPrint" style="width: 60%;">
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td align="left" style="width: 40%">
                        <input type="text" data-clear-btn="true" id="txtnaj_offcut_weight" value="0">
                    </td>
                </tr>
            </table>
            <table style="width: 100%">
...
<asp:Content ID="Content5" ContentPlaceHolderID="OtherPage" runat="server">
    ...
    <div id="diaSub" data-role="page" data-theme="c" data-cache="never">
        ...
        <div data-role="footer" data-position="fixed" data-tap-toggle="false" data-theme="e">
            <div data-role="fieldcontain" style="text-align: center">
                <div id="btnSubOk" href="#" data-rel="back" data-role="button" data-theme="c" data-icon="check">確定</div>
            </div>
        </div>
    </div>
    ...
    <div id="diaEdit" data-role="page" data-theme="c" data-cache="never">
        ...
        <div data-role="content">
            <table style="width: 100%;">
                ...
                <%--條數 txtnaj_bar_qty 開窗--%>
                <tr>
                    <td style="width: 20%; text-align: right;">
                        <span>條數：</span>
                    </td>
                    <td style="width: 80%; text-align: left;">
                        <input type="text" data-clear-btn="true" id="txtnaj_bar_qty" value="">
                    </td>
                </tr>
                <%--邊料分攤 txtnaj_offcut_share 開窗--%>
                <tr>
                    <td style="width: 20%; text-align: right;">
                        <span>邊料分攤：</span>
                    </td>
                    <td style="width: 80%; text-align: left;">
                        <input type="text" data-clear-btn="true" id="txtnaj_offcut_share" value="">
                    </td>
                </tr>
                <%--驗收量 cde_wait_qty--%>
                <tr>
