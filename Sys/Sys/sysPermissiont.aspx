<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.Master" AutoEventWireup="true" CodeBehind="sysPermissiont.aspx.cs" Inherits="eAIWeb.Sys.sysPermissiont" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" class="auto-table">
                    <tr>
                        <td colspan="7" style="height:8px;" align="left">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="7"  align="left">&nbsp;&nbsp;<asp:Label ID="lblControl_Typef" runat="server" Text="權限類型:" meta:resourcekey="lblControl_TypefResource1"></asp:Label>
                            &nbsp;<asp:DropDownList ID="ddlControl_Typef" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlControl_Typef_SelectedIndexChanged" meta:resourcekey="ddlControl_TypefResource1">
                                ...
                                <asp:ListItem meta:resourcekey="ListItemResource1" Value="R">角色</asp:ListItem>
                            ...
                            <asp:Button ID="btnRole" runat="server" OnClick="btnGroupSelect_Click" Text="角色" Visible="False" meta:resourcekey="btnRoleResource1" />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="lblRole" runat="server" Text="角色：" Visible="False" meta:resourcekey="lblRoleResource1"></asp:Label>
                            <asp:Label ID="lblRoleData" runat="server" Visible="False" meta:resourcekey="lblRoleDataResource1"></asp:Label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 60%;">
                                ...
                                <tr style="background-color: #fff;">
                                    ...
                                    <td align="right" style="width: 50%">
                                        <asp:Label ID="lblNew_Flag" runat="server" meta:resourcekey="lblNew_FlagResource1" Text="新增："></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:CheckBox ID="cbxNew_Flag" runat="server" meta:resourcekey="cbxNew_FlagResource1" />
                                    </td>
                                </tr>
                                <tr style="background-color: #fff;">
                                    <td align="right">
                                        D</td>
                                    <td align="right" style="width: 50%">
                                        <asp:Label ID="lblDelete_Flag" runat="server" meta:resourcekey="lblDelete_FlagResource1" Text="刪除："></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:CheckBox ID="cbxDelete_Flag" runat="server" meta:resourcekey="cbxDelete_FlagResource1" />
                                    </td>
                                </tr>
                                <tr style="background-color: #fff;">
                                    <td align="right">
                                        U</td>
                                    <td align="right" style="width: 50%">
                                        <asp:Label ID="lblModify_Flag" runat="server" meta:resourcekey="lblModify_FlagResource1" Text="修改："></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:CheckBox ID="cbxModify_Flag" runat="server" meta:resourcekey="cbxModify_FlagResource1" />
                                    </td>
                                </tr>
                                <tr style="background-color: #fff;">
                                    <td align="right">
                                        E</td>
                                    <td align="right" style="width: 50%">
                                        <asp:Label ID="lblExport_Flag" runat="server" meta:resourcekey="lblExport_FlagResource1" Text="匯出："></asp:Label>
                                    </td>
                                    <td align="left">
                                        <asp:CheckBox ID="cbxExport_Flag" runat="server" meta:resourcekey="cbxExport_FlagResource1" />
                                    </td>
                                </tr>
                                <tr style="background-color: #fff;">
